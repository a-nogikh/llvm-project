...
__sized_ptr_t __size_returning_new(size_t size) __attribute__((malloc));
__sized_ptr_t __size_returning_new_hot_cold(size_t, __hot_cold_t) __attribute__((malloc));
__sized_ptr_t __size_returning_new_aligned(size_t, std::align_val_t) __attribute__((alloc_size(1)));
